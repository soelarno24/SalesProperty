...
CREATE TABLE teams (
    ...
    description     TEXT,
    leader_id       CHAR(36), -- FK set after users table
...
ALTER TABLE project_facilities ADD CONSTRAINT fk_facilities_project
...
ALTER TABLE project_certificates ADD CONSTRAINT fk_certificates_project
    FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE;
...
ALTER TABLE project_images ADD CONSTRAINT fk_images_project
    FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE;
...
ALTER TABLE project_agents ADD CONSTRAINT fk_pa_project
    FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE;
ALTER TABLE project_agents ADD CONSTRAINT fk_pa_user
...
ALTER TABLE unit_types ADD CONSTRAINT fk_unit_types_project
    FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE;
...
ALTER TABLE units ADD CONSTRAINT fk_units_project
    FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE;
ALTER TABLE units ADD CONSTRAINT fk_units_type
...
ALTER TABLE units ADD CONSTRAINT fk_units_agent_booking
    FOREIGN KEY (booked_by_agent) REFERENCES users(id) ON DELETE SET NULL;
...
ALTER TABLE clients ADD CONSTRAINT fk_clients_agent
    FOREIGN KEY (assigned_agent_id) REFERENCES users(id) ON DELETE SET NULL;
ALTER TABLE clients ADD CONSTRAINT fk_clients_project
    FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE SET NULL;
ALTER TABLE clients ADD CONSTRAINT fk_clients_unit
...
ALTER TABLE client_timeline ADD CONSTRAINT fk_timeline_client
    FOREIGN KEY (client_id) REFERENCES clients(id) ON DELETE CASCADE;
ALTER TABLE client_timeline ADD CONSTRAINT fk_timeline_performed_by
...
ALTER TABLE follow_up_reminders ADD CONSTRAINT fk_reminders_user
    FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE;
ALTER TABLE follow_up_reminders ADD CONSTRAINT fk_reminders_client
    FOREIGN KEY (client_id) REFERENCES clients(id) ON DELETE CASCADE;
...
ALTER TABLE unit_bookings ADD CONSTRAINT fk_bookings_unit
    FOREIGN KEY (unit_id) REFERENCES units(id) ON DELETE CASCADE;
ALTER TABLE unit_bookings ADD CONSTRAINT fk_bookings_client
    FOREIGN KEY (client_id) REFERENCES clients(id) ON DELETE CASCADE;
ALTER TABLE unit_bookings ADD CONSTRAINT fk_bookings_agent
    FOREIGN KEY (agent_id) REFERENCES users(id) ON DELETE CASCADE;
ALTER TABLE unit_bookings ADD CONSTRAINT fk_bookings_leader_approved
    FOREIGN KEY (leader_approved_by) REFERENCES users(id) ON DELETE SET NULL;
ALTER TABLE unit_bookings ADD CONSTRAINT fk_bookings_admin_approved
...
ALTER TABLE transactions ADD CONSTRAINT fk_transactions_booking
    FOREIGN KEY (booking_id) REFERENCES unit_bookings(id) ON DELETE SET NULL;
ALTER TABLE transactions ADD CONSTRAINT fk_transactions_agent
    FOREIGN KEY (agent_id) REFERENCES users(id) ON DELETE SET NULL;
ALTER TABLE transactions ADD CONSTRAINT fk_transactions_approved_by
...
ALTER TABLE scheme_projects ADD CONSTRAINT fk_sp_scheme
    FOREIGN KEY (scheme_id) REFERENCES commission_schemes(id) ON DELETE CASCADE;
ALTER TABLE scheme_projects ADD CONSTRAINT fk_sp_project
    FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE;
...
ALTER TABLE commissions ADD CONSTRAINT fk_commissions_agent
    FOREIGN KEY (agent_id) REFERENCES users(id) ON DELETE CASCADE;
ALTER TABLE commissions ADD CONSTRAINT fk_commissions_scheme
    FOREIGN KEY (scheme_id) REFERENCES commission_schemes(id) ON DELETE SET NULL;
ALTER TABLE commissions ADD CONSTRAINT fk_commissions_booking
    FOREIGN KEY (booking_id) REFERENCES unit_bookings(id) ON DELETE SET NULL;
ALTER TABLE commissions ADD CONSTRAINT fk_commissions_leader_approved
    FOREIGN KEY (leader_approved_by) REFERENCES users(id) ON DELETE SET NULL;
ALTER TABLE commissions ADD CONSTRAINT fk_commissions_admin_approved
    FOREIGN KEY (admin_approved_by) REFERENCES users(id) ON DELETE SET NULL;
...
ALTER TABLE activity_logs ADD CONSTRAINT fk_activity_user
    FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE;
ALTER TABLE activity_logs ADD CONSTRAINT fk_activity_client
    FOREIGN KEY (client_id) REFERENCES clients(id) ON DELETE SET NULL;
ALTER TABLE activity_logs ADD CONSTRAINT fk_activity_project
    FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE SET NULL;
...
ALTER TABLE proof_of_work ADD CONSTRAINT fk_proof_activity
...
ALTER TABLE site_visits ADD CONSTRAINT fk_visits_agent
    FOREIGN KEY (agent_id) REFERENCES users(id) ON DELETE CASCADE;
ALTER TABLE site_visits ADD CONSTRAINT fk_visits_client
    FOREIGN KEY (client_id) REFERENCES clients(id) ON DELETE CASCADE;
ALTER TABLE site_visits ADD CONSTRAINT fk_visits_project
    FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE;
...
ALTER TABLE kpi_targets ADD CONSTRAINT fk_kpi_user
    FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE;
...
ALTER TABLE digital_assets ADD CONSTRAINT fk_assets_project
    FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE SET NULL;
ALTER TABLE digital_assets ADD CONSTRAINT fk_assets_uploaded_by
...
ALTER TABLE system_settings ADD CONSTRAINT fk_settings_updated_by
...
INSERT INTO teams (id, name, description) VALUES
    (UUID(), 'System Admin', 'Administrators');

SET @team_id = LAST_INSERT_ID();

INSERT INTO users (id, name, email, phone, password_hash, role, status, team_id) VALUES
    (UUID(), 'Agent Properti Admin', 'admin@agentproperti.id', '+62 812 0000 1111', 
     '$2b$12$placeholder_hash_replace_with_real_bcrypt', 'Admin', 'Active', @team_id);

SET @admin_id = LAST_INSERT_ID();

UPDATE teams SET leader_id = @admin_id WHERE id = @team_id;
...
-- users: All system users: Admin, Leader Sales, Sales Agent
-- teams: Sales teams managed by Leaders
-- developers: Real estate developer partners
-- projects: Housing/property development projects
-- units: Individual property units within projects
-- unit_types: Unit type templates with default pricing
-- clients: Prospective buyers / leads / customers
-- client_timeline: Chronological record of all client interactions
-- unit_bookings: Unit booking requests with approval workflow
-- transactions: Financial transactions (payments, fees)
-- commission_schemes: Commission calculation rules per project type
-- commissions: Individual commission records for agents
-- activity_logs: Daily activity logs from sales agents
-- proof_of_work: Evidence files: photos, screenshots, GPS check-ins
-- site_visits: Scheduled and completed property site visits
-- kpi_targets: Monthly KPI targets and actuals per agent
-- digital_assets: Brochures, price lists, renderings
-- audit_logs: System-wide audit trail for all admin actions
-- follow_up_reminders: Calendar reminders for client follow-ups
-- system_settings: Application configuration key-value store

-- proof_of_work.is_from_camera: TRUE means photo taken live from camera app, not selected from gallery
-- units.booking_expires: 24-hour countdown. Unit auto-releases if payment not received
-- unit_bookings.status: Approval chain: Sales submits → Leader validates → Admin finalizes